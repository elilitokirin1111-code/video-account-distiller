...
class ErrorCode(StrEnum):
    ...
    COLLECTION_BUDGET_EXCEEDED = "E_COLLECTION_BUDGET_EXCEEDED"
    GPT_EVALUATION_BUDGET_EXCEEDED = "E_GPT_EVALUATION_BUDGET_EXCEEDED"
    PROJECT_MIGRATION_CONFIRMATION_REQUIRED = "E_PROJECT_MIGRATION_CONFIRMATION_REQUIRED"
    PROJECT_MIGRATION_UNSUPPORTED = "E_PROJECT_MIGRATION_UNSUPPORTED"
    PUBLIC_BETA_GATE_FAILED = "E_PUBLIC_BETA_GATE_FAILED"
    TASK_INTERRUPTED = "E_TASK_INTERRUPTED"
    TASK_QUEUE_FULL = "E_TASK_QUEUE_FULL"
...
EXIT_CODES: dict[ErrorCode, int] = {
    ...
    ErrorCode.COLLECTION_BUDGET_EXCEEDED: 27,
    ErrorCode.TASK_INTERRUPTED: 28,
    ErrorCode.TASK_QUEUE_FULL: 29,
    ErrorCode.GPT_EVALUATION_BUDGET_EXCEEDED: 30,
    ErrorCode.PROJECT_MIGRATION_CONFIRMATION_REQUIRED: 31,
    ErrorCode.PROJECT_MIGRATION_UNSUPPORTED: 32,
    ErrorCode.PUBLIC_BETA_GATE_FAILED: 33,
